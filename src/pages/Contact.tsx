...
const Contact: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Contact Dr. Pratik Kishore | Neurologist & Neurovascular Specialist</title>
        <meta name="description" content="Schedule a consultation with Dr. Pratik Kishore, a leading neurologist and neurovascular intervention specialist at BLK-Max Super Speciality Hospital, New Delhi." />
        <meta name="keywords" content="Dr. Pratik Kishore, Neurologist, Neurovascular, BLK-Max, Stroke Management, Delhi" />
      </Helmet>
